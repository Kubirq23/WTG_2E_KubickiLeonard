...
public class ColumNenager : MonoBehaviour //literówka // wiem
{
    [SerializeField]
    ...
    //creating column
    private void CreateAlienColumn()
    { //zamiast dawać comentarz ten co wyżej, możesz po prostu nazwać metodę CreateAlienColumn()
